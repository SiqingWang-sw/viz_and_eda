...
```
    ...
    ## using cached file: /Users/siqingwang/Library/Caches/org.R-project.R/R/rnoaa/noaa_ghcnd/USW00022534.dly

    ## date created (size, mb): 2023-09-28 10:20:49.706204 (3.83)

    ## file min/max dates: 1949-10-01 / 2023-09-30

    ## using cached file: /Users/siqingwang/Library/Caches/org.R-project.R/R/rnoaa/noaa_ghcnd/USS0023B17S.dly

    ## date created (size, mb): 2023-09-28 10:20:53.22839 (0.994)
...
``` r
weather_df |> count(name, name = "n_obs") #count by names and rename the column 
```
